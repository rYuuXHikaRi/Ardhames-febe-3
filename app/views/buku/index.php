...
Buku</a><a href="<?= base_url; ?>/buku/laporan" class="btn float-right btn-xs btn btninfo">Laporan Buku</a></div>
 </div>
 <div class="card-body">
...
$row['nama_kategori'];?></div></td>
 ...
 <td>
 <a href="<?= base_url; ?>/buku/edit/<?= $row['id'] ?>" class="badge badgeinfo">Edit</a> <a href="<?= base_url; ?>/buku/hapus/<?= $row['id'] ?>" class="badge badgedanger" onclick="return confirm('Hapus data?');">Hapus</a>
 </td>
 </tr>
 <?php $no++; endforeach; ?>
 </tbody>
